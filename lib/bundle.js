...
function bundleInstall(){
  ...
  if (this.options.use_docker) {
    ...
    if (this.options.docker_file) {
      ...
      docker_steps.push('RUN mkdir /var/gem_build')
      docker_steps.push('WORKDIR /var/gem_build')
      ...
      // TODO - Add a step to install the correct version of bundler
      ...
      // TODO - Maybe we need to set bundler config values differently based on the bundler version that's installed
